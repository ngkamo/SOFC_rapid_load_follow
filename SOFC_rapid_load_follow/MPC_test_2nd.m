...
% r_target = [10; 0; -0.01];
r_target = [[-10; 0].*ones(2,50), zeros(2,300)]; % profile demand
...
[solutions,infeasible] = steady_target{r_target};
...
for j = 1:Nsim
    ...
    x_target = solutions1{1};
    u_target = solutions1{2};
